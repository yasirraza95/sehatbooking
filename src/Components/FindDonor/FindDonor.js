                                ...
                                <div className="banner-area__content">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol className="breadcrumb">
                                            ...
                                            <li className="breadcrumb-item active" aria-current="page">Find Donor</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="panel panel-default">
                                ...
                                <div id="donor_search" className="panel-collapse collapse in" style={{ height: "auto" }}>
                            ...
                            <div className="table-responsive">
                                <table className="table table-striped table-hover responsive">
                                    <tbody><tr>
                                        <th><div className="wordbreak">Donor Name</div></th>
                                        <th><div className="wordbreak">Blood Group</div></th>
                                        <th><div className="wordbreak">Donor Address</div></th>
                                        <th><div className="wordbreak">Contact Donor</div></th>
                                    </tr>
                                        <tr>
                                            <td><div className="wordbreak">abcdef</div></td>
                                            <td><div className="wordbreak">A-</div></td>
                                            <td><div className="wordbreak">Karachi, Bahadurabad</div></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><div className="wordbreak">Hatim Mustafa </div></td>
                                            <td><div className="wordbreak">A-</div></td>
                                            <td><div className="wordbreak">Karachi, D.H.A</div></td>
                                            <td>
                                                <a href="" onclick="show_registration_dialog()">
                                                    <FontAwesomeIcon icon={faMobileScreenButton} />
                                                </a>                </td>
                                        ...
                                        <tr>
                                            <td><div className="wordbreak">Asad Khalid</div></td>
                                            <td><div className="wordbreak">A-</div></td>
                                            <td><div className="wordbreak">Karachi, Gulistan-e-Jauhar</div></td>
                                            <td>
                                                <a href="" onclick="show_registration_dialog()">
                                                    <FontAwesomeIcon icon={faMobileScreenButton} />
                                                </a>                </td>
                                        ...
                                        <tr>
                                            <td><div className="wordbreak">Haji Najam Awan</div></td>
                                            <td><div className="wordbreak">A-</div></td>
                                            <td><div className="wordbreak">Karachi, Saddar</div></td>
                                            <td>
                                                <a href="" onclick="show_registration_dialog()">
                                                    <FontAwesomeIcon icon={faMobileScreenButton} />
                                                </a>                </td>
                                        ...
                                        <tr>
                                            <td><div className="wordbreak">najam</div></td>
                                            <td><div className="wordbreak">A-</div></td>
                                            <td><div className="wordbreak">Karachi, Saddar</div></td>
                                            <td>
                                                <a href="" onclick="show_registration_dialog()">
                                        ...
                                        <tr>
                                            <td><div className="wordbreak">Salman Khan</div></td>
                                            <td><div className="wordbreak">A-</div></td>
                                            <td><div className="wordbreak">Karachi, North Nazimabad</div></td>
                                            <td>
                                                <a href="" onclick="show_registration_dialog()">
                                                    <FontAwesomeIcon icon={faMobileScreenButton} />
                                                </a>                </td>
                                        ...
                                        <tr>
                                            <td><div className="wordbreak">Syed Shahbaz Ali</div></td>
                                            <td><div className="wordbreak">A-</div></td>
                                            <td><div className="wordbreak">Karachi, North Nazimabad</div></td>
                                            <td>
                                                <a href="" onclick="show_registration_dialog()">
