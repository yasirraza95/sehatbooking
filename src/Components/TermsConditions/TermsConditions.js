...
export default function TermsConditions() {
  ...
  return (
    <>
      ...
      {/* <!-- ==== terms section start ==== --> */}
      <section className="terms section-space">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="privacy-area terms-area">
                <div className="poster">
                  <img
                    src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679158386/Sehatbooking/terms-poster_fmlssf.png"
                    alt="Terms & Conditions"
                  />
                </div>
                <div className="group">
                  <h3>Reasons for Using Website Terms and Conditions</h3>
                  <p>
                    ...
                    anything embarrassing hidden in middle of text. All the
                ...
                <div className="group">
                  ...
                  <p>
                    ...
                    except to obtain some advantage from But who has any right
                ...
                <div className="group">
                  ...
                  <div className="img-group wow fadeInUp">
                    <img
                      src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679158385/Sehatbooking/img-group-one_fpkllt.png"
                      alt="Terms"
                    />
                    <img
