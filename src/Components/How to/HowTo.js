                                ...
                                <div className="banner-area__content">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol className="breadcrumb">
                                            ...
                                            <li className="breadcrumb-item active" aria-current="page">How to</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div className="contact-area">
                                <div className="contact-area__content">
                                    ...
                                    <h4 className="descender">Steps For Usage!</h4>
                                            <div className="group">
                                                    <p className="secondary"><i  className="bi bi-telephone-fill"></i> Emergency Request
                                                    </p>
                                                    <p className="secondary"><i  className="bi bi-geo-alt-fill"></i> Find Donor</p>
                                                    <p className="secondary"><i  className="bi bi-clock-fill"></i> Donate Blood
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
