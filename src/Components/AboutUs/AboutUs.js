                                ...
                                <div className="row d-flex align-items-center neutral-row">
                                    <div className="col-lg-6 row-item">
                                        <div className="who-area__content wow fadeInUp">
                                            ...
                                            <h5 className="descender">We are here not for income, but for outcome</h5>
                                            <p>Which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when untrammelled and when nothing prevents through shrinking from toil and pain. These cases are</p>
                                    ...
                                    <div className="col-lg-6 row-item order-first order-lg-last">
                                        <div className="who-area__thumb text-start text-lg-center">
                                            <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679158385/Sehatbooking/img-group-two_jlrjkl.png" alt="Who We Are" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="odometer-item mb-30">
                                            <div className="counter-thumb">
                                                <h2 className="odometer light neutral-ascender-light" data-odometer-final="25">0</h2>
                                            </div>
                                            <p className="secondary neutral-descender">Year's Experience</p>
                                        </div>
                                    </div>
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="odometer-item mb-30">
                                            <div className="counter-thumb">
                                                <h2 className="odometer light neutral-ascender-light" data-odometer-final="430">0</h2>
                                            </div>
                                            <p className="secondary neutral-descender">Blood Donations</p>
                                        </div>
                                    </div>
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="odometer-item mb-30 mbs">
                                            <div className="counter-thumb">
                                                <h2 className="odometer light neutral-ascender-light" data-odometer-final="90">0</h2>
                                            </div>
                                            <p className="secondary neutral-descender">Total Awards</p>
                                        </div>
                                    </div>            
                                    <div className="col-lg-3 col-sm-6">
                                        <div className="odometer-item">
                                            <div className="counter-thumb">
                                                <h2 className="odometer light neutral-ascender-light" data-odometer-final="35">0</h2>
                                            </div>
                                            <p className="secondary neutral-descender">Blood Cooperations</p>
                                        </div>
                                    </div>             
                                </div>
                            </div>
                                ...
                                <div className="row d-flex align-items-center neutral-row">
                                    <div className="col-lg-6 row-item">
                                        <div className="organization-area__thumb text-center">
                                            <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679164969/Sehatbooking/organization-two_s0h4b2.png" alt="Organization" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 row-item">
                                        <div className="organization-area__content wow fadeInUp">
                                            <p className="neutral-ascender primary descender">Help The People in Need</p>
                                            ...
                                            <div className="organization-area__content-points">
                                                <ul>
                                                    <li><i className="fa-solid fa-angles-right"></i>Good Service</li>
                                                    <li><i className="fa-solid fa-angles-right"></i>Help People</li>
                                                    <li><i className="fa-solid fa-angles-right"></i>Hygine Tools</li>
                                                </ul>
                                                <ul>
                                                    <li><i className="fa-solid fa-angles-right"></i>24h Service</li>
                                                    <li><i className="fa-solid fa-angles-right"></i>Health Check</li>
                                                    <li><i className="fa-solid fa-angles-right"></i>Blood Bank</li>
                                                </ul>
                                            </div>
                                            <a href="services.html" className="button button--effect">Explore Now</a>
                                        </div>
                                ...
                                <div className="row neutral-row">
                                        ...
                                        <div className="campaign--secondary-single img-effect">
                                            <div className="poster">
                                                <a href="campaign-details.html">
                                                    <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679165259/Sehatbooking/collection_jweqwh.png" alt="collection" />
                                                </a>
                                            ...
                                            <div className="campaign--secondary-single__inner">
                                                <h4><a href="campaign-details.html">Blood Group Collection</a></h4>
                                                <p className="neutral-bottom">Lorem ipsum dolor sit elit consectetur adipiscing ipsum elit, sed do incididunt et dolore adipiscing magna aliqua ipsum dolor sit elit consectetur adipiscing ipsum elit, sed do magna aliqua ipsum dolor sit elit consectetur adipiscing.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-sm-10 col-md-6 col-lg-4 col-xl-3 row-item align-center">
                                        <div className="campaign--secondary-single img-effect wow fadeInUp">
                                            <div className="poster">
                                                <a href="campaign-details.html">
                                                    <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679165259/Sehatbooking/checking_c6onbc.png" alt="Checking" />
                                                </a>
                                            </div>
                                            <div className="campaign--secondary-single__inner">
                                                <p className="post-date-small"><i className="fa-solid fa-calendar-days"></i>13 February, 2022</p>
                                                <h6><a href="campaign-details.html">Free Group Checking</a></h6>
                                                <p className="neutral-bottom">Lorem ipsum dolor sit consectetur adipiscing elit, sed do incididunt et dolore magna aliqua consectetur.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-sm-10 col-md-6 col-lg-4 col-xl-3 row-item align-center">
                                        <div className="campaign--secondary-single img-effect wow fadeInUp" data-wow-delay="0.2s">
                                            <div className="poster">
                                                <a href="campaign-details.html">
                                                    <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679165259/Sehatbooking/camp_ovhfen.png" alt="camp" />
                                                </a>
                                            </div>
                                            <div className="campaign--secondary-single__inner">
                                                <p className="post-date-small"><i className="fa-solid fa-calendar-days"></i>13 February, 2022</p>
                                                <h6><a href="campaign-details.html">Blood Donation Camp</a></h6>
                                                <p className="neutral-bottom">Lorem ipsum dolor sit consectetur adipiscing elit, sed do incididunt et dolore magna aliqua consectetur.</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="call-area">
                            ...
                            <p className="primary neutral-ascender descender">Start Donating</p>
                            <h2 className="descender">Call Now : 333 555 9090</h2>
                            <div className="group">
                                <a href="contact-us.html">
                                <i className="bi bi-geo-alt-fill"></i><span>New York – 1075 Firs Avenue</span>
                                </a>
                                <a href="mailto:company@domin.com">
                                <i className="bi bi-envelope-fill"></i><span>donate@gmail.com</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="process-area">
                            <div className="section-header section-inner-space">
                                <p className="primary neutral-ascender descender">What We Do</p>
                            ...
                            <div className="row neutral-row justify-content-center">
                                <div className="col-sm-10 col-md-6 col-lg-4 row-item align-center">
                                    <div className="team-area__single img-effect">
                                        <div className="poster">
                                            <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679166695/Sehatbooking/nora_knntzw.png" alt="Nora"/>
                                ...
                                <div className="col-sm-10 col-md-6 col-lg-4 row-item align-center">
                                    <div className="team-area__single img-effect wow fadeInUp">
                                        <div className="poster">
                                            <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679166695/Sehatbooking/joshi_j6s1mb.png" alt="Alex Joshan Deo"/>
                                            <div className="social social--secondary">
                                                <a href="https://www.facebook.com/">
                                                    <i className="bi bi-facebook"></i>
                                                </a>
                                ...
                                <div className="col-sm-10 col-md-6 col-lg-4 row-item align-center">
                                    <div className="team-area__single img-effect wow fadeInUp" data-wow-delay="0.2s">
                                        <div className="poster">
                                            <img src="https://res.cloudinary.com/dll4d2yu7/image/upload/v1679166694/Sehatbooking/alex_kzyvxs.png" alt="Alex Joshi Deon"/>
                                            <div className="social social--secondary">
                                                <a href="https://www.facebook.com/">
                                                    <i className="bi bi-facebook"></i>
                                                </a>
