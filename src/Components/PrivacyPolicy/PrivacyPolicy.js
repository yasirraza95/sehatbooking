                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="privacy-area">
                            <div className="group">
                                <h3>Privacy Policy for Blad Ai</h3>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                    ...
                                    isn't
                                    anything embarrassing hidden in middle of text. All the Lorem Ipsum generators on the
                                    Internet
                            ...
                            <div className="group">
                                ...
                                <ul>
                                    <li><i  className="bi bi-check-circle-fill"></i> Duis aute irure dolor in reprehenderit in
                                        voluptate
                            ...
                            <div className="group">
                                ...
                                <p>Nor again is there anyone who loves or pursues or desires to obtain pain of itself,
                                    ...
                                    physical
                                    exercise, except to obtain some advantage from But who has any right to find fault with
                                    a man
                                </p>
                            </div>
                            <div className="group">
                            ...
                            <div className="group">
                                <h4>Blood Donate Information</h4>
                                <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising
                                    pain was
                                    born and I will give you a complete account of the system, and expound the actual
                                    teachings of
